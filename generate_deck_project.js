// generate_deck_project.js -- Project lesson type.
//
// Same situation as Unit Launch: no dedicated visual .pptx template
// exists for Project, so this is built against the written "Knowledge
// Slide Template Outlines" spec's "Project Lesson" section, reusing
// Reading's verified colors/chrome/helper functions wholesale. Structure
// per that outline:
//   1. Cover + title
//   2. EQ/TP/Language Goal
//   3-6. Engage/Launch: vocab, read directions, resource references
//   7-8+. Work Period sections (this lesson's own names -- "Create",
//         "Creators' Circle", "Revise" -- not the outline's generic
//         placeholder names, per its own instruction to match the
//         lesson's actual section titles)
//   9. Closing
//   10. Lesson Vocabulary Review
// Verified against the real Lesson 4b ("Project") content in
// RT_Gr4U2_KNO_full_unit_Teacher_Guide.pdf (physical pages 121-128).
const pptxgen = require("pptxgenjs");
const fs = require("fs");

const lessonPath = process.argv[2] || "lesson_4b_REAL.json";
...
// Chart/planner table: same purple-header, zebra-row rendering as
...
// ===== Slides: Work Period sections (Create / Creators' Circle / Revise,
// or whatever this lesson's own section names are -- per the outline,
